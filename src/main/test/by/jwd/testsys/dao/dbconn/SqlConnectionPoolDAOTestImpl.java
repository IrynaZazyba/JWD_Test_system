...
public final class SqlConnectionPoolDAOTestImpl implements ConnectionPoolDAO {
    ...
    public SqlConnectionPoolDAOTestImpl() {
        DBResourceManagerTest dbResourseManager = DBResourceManagerTest.getInstance();
        this.driverName = dbResourseManager.getValue(DBParameterTest.DB_DRIVER);
        this.url = dbResourseManager.getValue(DBParameterTest.DB_URL);
        this.user = dbResourseManager.getValue(DBParameterTest.DB_USER);
        this.password = dbResourseManager.getValue(DBParameterTest.DB_PASSWORD);
        try {
            this.poolSize = Integer.parseInt(dbResourseManager
                    .getValue(DBParameterTest.DB_POLL_SIZE));
