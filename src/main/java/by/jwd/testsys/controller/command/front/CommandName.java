...
public enum CommandName {
    ...
    ADD_TEST(Role.ADMIN), PREVIEW_TEST(Role.ADMIN),SHOW_ASSIGNED_TESTS_PAGE(Role.USER),ABOUT_US(Role.USER),MAIN_PAGE(Role.USER),
    WRONG_REQUEST(Role.USER),CONFIRM_EMAIL(Role.USER),DELETE_TEST_TYPE_PAGE(Role.ADMIN);
