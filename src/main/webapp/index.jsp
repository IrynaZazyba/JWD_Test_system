...
<div class="container p-150 ">
    <div class="row align-items-center">
        ...
        <div class="col-4">
            ...
            <div class="tab-content bor-gray-solid" id="nav-tabContent">
                <c:choose>
                <c:when test="${sign_up_error!=null}">
                                ...
                                <div class="form-group">
                                    <div>
                                        <c:if test="${sign_in_error!=null}">
                                            <h5 class="t-color-red">${sign_in_error}</h5></c:if>
                        ...
                        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                            ...
                            <div class="form">
                                <form action="test" class="form-horizontal" role="form" method="POST">
                                    ...
                                    <div class="form-group">
                                        <div>
                                            <h6 class="t-color-red">   <c:if test="${sign_up_error!=null}">
                                                ${sign_up_error}</c:if></h6>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <button type="submit" class="btn btn-outline-primary btn-sm">Sign up
                                                </button>
                                            </div>
                                        </div>
                                    </div>
